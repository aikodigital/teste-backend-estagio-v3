...
public class EquipmentUpdateDTO {
    ...
    public EquipmentUpdateDTO(int equipmentId, String equipmentName, String equipmentState, String equipmentModel, int earningsPerHour, String historyState, String historyPosition) {
