...
namespace src_teste_backend_estagio_v3.Context;

public partial class ForestOpContext : DbContext
{
    public ForestOpContext()
    {
    }

    public ForestOpContext(DbContextOptions<ForestOpContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseNpgsql("Host=localhost;Database=forest-op;Username=postgres;Password=674295");
